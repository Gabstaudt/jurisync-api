...
const mapProcess = (row: any) => ({
  ...
  claimValue: row.claim_value !== null ? Number(row.claim_value) : null,
  feesValue: row.fees_value !== null ? Number(row.fees_value) : null,
  feesPercentage: row.fees_percentage !== null ? Number(row.fees_percentage) : null,
